...
import com.example.board.service.ExcelExportService;
import com.example.board.service.OurHomeScraperService;
...
@Slf4j
public class OurHomeScraperController {
    
    private final OurHomeScraperService scraperService;
    private final ExcelExportService excelExportService;
    
    /**
     * 크롤링 페이지
     * GET /project/kalisco/crawling/saleSituation/
     */
    @GetMapping("/project/kalisco/crawling/saleSituation/")
    public ResponseEntity<String> crawlingPage() {
        try {
            log.info("크롤링 페이지 접근: /project/kalisco/crawling/saleSituation/");
            
            ClassPathResource resource = new ClassPathResource("static/project/kalisco/crawling/saleSituation/index.html");
    ...
    /**
     * 매장 목록 조회 API
     * GET /api/ourhome/store-list?saleType=menu
     */
    @GetMapping("/api/ourhome/store-list")
    @ResponseBody
     ...
     * POST /api/ourhome/menu-sales
     */
    @PostMapping("/api/ourhome/menu-sales")
    @ResponseBody
    ...
    /**
     * 매출 데이터 엑셀 다운로드
     * GET /api/ourhome/menu-sales/excel?startDate=2025-11-11&endDate=2025-11-11&saleType=menu
     * GET /api/ourhome/menu-sales/excel?year=2025&month=11&saleType=daily
     */
    @GetMapping("/api/ourhome/menu-sales/excel")
